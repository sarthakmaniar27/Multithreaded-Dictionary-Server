...
public class DictionaryWindow implements Runnable{
	...
	private void GUI() {
		...
		wordField.setForeground(Color.BLUE);
		...
		addWordField.setBackground(Color.ORANGE);
		addWordField.setForeground(Color.BLUE);
		...
		addMeaningsArea.setForeground(Color.GREEN);
		...
		removeField.setBackground(Color.ORANGE);
		removeField.setForeground(Color.BLUE);
